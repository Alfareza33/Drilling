      ...
      <card-component>
        <form @submit.prevent="submit">
          ...
          <b-field horizontal label="ID">
            <b-field>
              <b-input v-model="form.name" placeholder="ID" name="id" required />
            </b-field>
          </b-field>
          <b-field horizontal label="Unit">
            <b-field>
              <b-input placeholder="Unit" name="unit" required />
            </b-field>
          </b-field>
          ...
          <b-field horizontal label="Api">
            <b-input placeholder="Api" v-model="form.subject" required />
          </b-field>
