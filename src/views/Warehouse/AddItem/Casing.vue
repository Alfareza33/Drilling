      ...
      <card-component>
        <form @submit.prevent="submit">
          ...
          <b-field horizontal label="Size">
            <b-field>
              <b-input v-model="form.name" placeholder="Size" name="size" required />
            </b-field>
          </b-field>
          <b-field horizontal label="Grade">
            <b-field>
              <b-input placeholder="Grade" name="grade" required />
            </b-field>
          </b-field>
          <b-field horizontal label="Pounder">
            <b-input placeholder="Pounder" v-model="form.subject" required />
          </b-field>
          <b-field horizontal label="Blank or Perforated">
            <b-input placeholder="Blank or Perforated" v-model="form.subject" required />
          </b-field>
          <b-field horizontal label="Wellding">
            <b-input placeholder="Wellding" v-model="form.subject" required />
          </b-field>
          <b-field horizontal label="Range">
          ...
          <b-field horizontal label="Connection">
